...
public class SearchResultNewActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private final String Database_Path = "bakos_db/tag";
    private final String Database_Path_Produk = "bakos_db/produk";
    ...
    public void onLocationChanged(Location location) {
        mylocation = location;
        if (mylocation != null) {
            AllProductResultActivity.gpsLat = mylocation.getLatitude();
            AllProductResultActivity.gpsLong = mylocation.getLongitude();
