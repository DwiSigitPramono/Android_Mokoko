                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                alertDialogBuilder
                                        ...
                                        .setMessage("Perubahan email tidak berhasil, kata sandi yang kamu masukan salah. Untuk menjaga keamanan akun ini, maka silahkan masuk kembali")
                                        .setCancelable(false)
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                alertDialogBuilder
                                        .setTitle("Perubahan Email")
                                        .setMessage("Perubahan email telah berhasil, kami telah mengirimkan email ke " + user.getEmail() + " untuk  memverifikasi alamat email kamu.")
                                        .setCancelable(false)
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                FirebaseAuth.getInstance().signOut();
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        alertDialogBuilder
                                                ...
                                                .setMessage("Perubahan kata sandi tidak berhasil, kata sandi lama yang kamu masukan salah. Untuk menjaga keamanan akun ini, maka silahkan masuk kembali")
                                                .setCancelable(false)
                                                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                    public void onClick(DialogInterface dialog, int id) {
                                                        FirebaseAuth.getInstance().signOut();
