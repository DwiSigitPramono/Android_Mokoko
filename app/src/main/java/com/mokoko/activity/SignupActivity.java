...
public class SignupActivity extends AppCompatActivity {
    ...
    private void daftarToko(String id){
        ...
        String idUser = "TKO"+ StringUtils.repeat('0',8-inc.length())+inc;
        TokoUpload tu = new TokoUpload(idUser,alamatToko, email, namaPemilik, namaToko, telpToko, kec, imgURL, imgURL2, lokasi, id, "0",0,"0");
