...
import com.mokoko.R;
import com.mokoko.model.NavDrawerItem;
...
public class FragmentDrawer extends Fragment {
    ...
    private static List<NavDrawerItem> getData() {
        ...
        if(FirebaseAuth.getInstance().getCurrentUser() != null) {
            if(FirebaseAuth.getInstance().getCurrentUser().getDisplayName().contains("Toko")) {
                ...
                for (int i = 0; i < titles_user.length; i++) {
                    NavDrawerItem navItem = new NavDrawerItem();
                    navItem.setTitle(titles_user[i]);
                    navItem.setIcon(navMenuIcons_user.getResourceId(i, i));
                    data.add(navItem);
                }
            }
        }else {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        titles_user = getActivity().getResources().getStringArray(R.array.nav_drawer_user);
        navMenuIcons = getResources().obtainTypedArray(R.array.nav_drawer_icons);
        navMenuIcons_login = getResources().obtainTypedArray(R.array.nav_drawer_icons_login);
        navMenuIcons_user = getResources().obtainTypedArray(R.array.nav_drawer_icons_user);
    }
