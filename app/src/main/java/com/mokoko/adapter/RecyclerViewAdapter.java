...
import static com.mokoko.activity.AllProductResultActivity.gpsLong;
import static com.mokoko.activity.AllProductResultActivity.gpsLat;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (uploadInfo.getJenisPromo().contains("Gratis Produk")){
            ...
            holder.txtHargaProduk.setTextColor(Color.parseColor("#F14950"));
