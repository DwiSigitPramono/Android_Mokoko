...
import com.mokoko.R;
import com.mokoko.activity.KatalogActivity;
import com.mokoko.activity.ProdukDetilActivity;
import com.mokoko.activity.UbahPromoActivity;
...
public class RecyclerViewKatalogAdapter extends RecyclerView.Adapter<RecyclerViewKatalogAdapter.ViewHolder> {
    ...
    private final String Database_Path = "bakos_db/produk";
        ...
        public ViewHolder(final View itemView) {
            ...
            btHapus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    alertDialogBuilder
                            .setMessage("Apakah kamu yakin ingin menghapus promo ini? ")
                            .setCancelable(true)
    ...
    private void removeTag(String judul, String PromoUploadId){
        ...
        String Database_Path_Tag = "bakos_db/tag";
